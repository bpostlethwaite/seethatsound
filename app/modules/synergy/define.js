...
function getDataScript(element) {
  ...
  return fc && fc.nodeName === "SCRIPT" && fc.type === "data" && fc;
}
  ...
  let X = class extends HTMLElement {
    ...
    constructor() {
      ...
      if (options.shadowRoot) {
        ...
        this.viewmodel.beforeMountCallback = (frag) => mergeSlots(this, frag);
      }
      ...
      let puc = this.viewmodel.updatedCallback || function () {};
